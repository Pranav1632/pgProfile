...
function App() {
  ...
  const toggleLanguage = () => {
    setLanguage(
      language === 'en' ? 'mr' : language === 'mr' ? 'hi' : 'en'
    )
  }
  ...
  return (
    ...
    >
      ...
      <div className="bg-white bg-opacity-90 rounded-xl shadow-lg max-w-4xl mx-auto p-6 mb-8">
        <h5 className="text-center font-thin text-gray-400 mb-2">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-800 ml-2">
              {language === 'en' ? '7499167820' : '७४९९१६७८२०'}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc ml-6 text-blue-600 underline space-y-1">
              ...
              <li>
                <a
                  href="https://drive.google.com/file/d/1UV_flYrSJn1scwti7xKUyTx89MIZQWjH/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Resume
      ...
      <div className="bg-white bg-opacity-90 rounded-xl shadow-lg max-w-4xl mx-auto p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-800 ml-2">
              {language === 'en'
                ? `Third-year Computer Engineering student with hands-on backend
                   development experience across Node.js/Express, TypeScript,
                   and Python/FastAPI — including distributed systems, message
                   queues, and database design — plus applied experience building
                   AI-driven workflows and LLM integrations. Comfortable working
                   across API, database, and integration layers with strong DSA,
                   OOP, and DBMS fundamentals. Seeking a Backend/SDE Internship
                   to build and maintain production systems used by real users.`
                : language === 'hi'
